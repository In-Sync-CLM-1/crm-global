 ...
 export function CompactConversationList({
   ...
   const getLastMessagePreview = (conv: Conversation) => {
     ...
     let body: string;
     if (conv.last_message.message_type === "file") body = "📎 File";
     else if (conv.last_message.message_type === "task_share") body = "📋 Task";
     else body = conv.last_message.content?.substring(0, 30) || "";
